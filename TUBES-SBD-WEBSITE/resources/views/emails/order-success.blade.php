...
<head>
    ...
    <title>Your Met Museum Ticket Confirmation</title>
    <style type="text/css">
        body, table, td, a { -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; }
        table, td { mso-table-lspace: 0pt; mso-table-rspace: 0pt; }
        img { -ms-interpolation-mode: bicubic; border: 0; outline: none; text-decoration: none; }
        body { margin: 0; padding: 0; width: 100% !important; background-color: #f4f4f4; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased; color: #222222; }
        a { color: #B10F2E; text-decoration: underline; }
        .wrapper { width: 100%; table-layout: fixed; background-color: #f4f4f4; padding-top: 40px; padding-bottom: 40px; }
        ...
        .hero { background-color: #B10F2E; color: #ffffff; padding: 40px 30px; text-align: center; }
        .hero h1 { margin: 0; font-size: 28px; font-weight: 300; letter-spacing: 2px; text-transform: uppercase; }
        .hero p { margin: 10px 0 0; font-size: 16px; color: #f8e9ec; font-weight: 300; }
        .content { padding: 40px 30px; }
        .greeting { font-size: 20px; font-weight: bold; color: #222222; margin-top: 0; margin-bottom: 10px; }
        .intro-text { font-size: 16px; color: #222222; line-height: 1.5; margin-top: 0; margin-bottom: 30px; }
        
        .summary-card { background-color: #ffffff; border: 1px solid #e7e7e7; border-radius: 6px; padding: 20px; margin-bottom: 30px; box-shadow: 0 2px 6px rgba(0,0,0,0.02); }
        .summary-card h3 { margin-top: 0; margin-bottom: 15px; font-size: 16px; color: #8C0C24; text-transform: uppercase; letter-spacing: 1px; border-bottom: 2px solid #F8E9EC; padding-bottom: 10px; }
        .summary-table { width: 100%; }
        .summary-table td { padding: 6px 0; font-size: 14px; color: #222222; }
        .summary-table td.label { font-weight: bold; color: #222222; width: 40%; }
        
        .ticket-card { border: 1px solid #e7e7e7; border-left: 4px solid #B10F2E; border-radius: 8px; padding: 20px; margin-bottom: 20px; background-color: #ffffff; box-shadow: 0 2px 8px rgba(0,0,0,0.02); }
        .ticket-header { font-size: 18px; font-weight: bold; color: #8C0C24; margin-top: 0; margin-bottom: 15px; border-bottom: 1px solid #e7e7e7; padding-bottom: 10px; }
        .ticket-layout { width: 100%; }
        .ticket-info { font-size: 14px; color: #222222; line-height: 1.6; }
        .ticket-info strong { color: #222222; }
        .ticket-qr { text-align: right; width: 160px; vertical-align: top; }
        .qr-wrapper { background: #ffffff; padding: 10px; border: 1px solid #B10F2E; border-radius: 4px; display: inline-block; }
        ...
        .status-valid { background-color: #F8E9EC; color: #B10F2E; }
        .status-pending { background-color: #fef7e0; color: #f29900; }
        .status-used { background-color: #e1f5fe; color: #01579b; }

        .info-panel { background-color: #F8E9EC; border-left: 4px solid #B10F2E; padding: 20px; margin-top: 30px; margin-bottom: 30px; border-radius: 0 6px 6px 0; }
        .info-panel h4 { margin-top: 0; margin-bottom: 10px; font-size: 15px; color: #8C0C24; text-transform: uppercase; letter-spacing: 1px; }
        .info-panel ul { margin: 0; padding-left: 20px; font-size: 14px; color: #222222; line-height: 1.6; }
        .info-panel li { margin-bottom: 8px; }

        .btn-container { text-align: center; margin-top: 30px; margin-bottom: 10px; }
        .btn { display: inline-block; background-color: #B10F2E; color: #ffffff !important; text-decoration: none; font-size: 16px; font-weight: bold; padding: 14px 28px; border-radius: 4px; text-transform: uppercase; letter-spacing: 1px; }

        .footer { background-color: #8C0C24; color: #F8E9EC; text-align: center; padding: 30px; font-size: 12px; line-height: 1.5; border-bottom-left-radius: 8px; border-bottom-right-radius: 8px; }
            ...
            <tr>
                <td align="center">
                    ...
                    <table class="main-content" width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="max-width: 600px;">
                                ...
                                <div class="summary-card">
                                    ...
                                    <table class="summary-table" width="100%" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td><strong style="color: #B10F2E;">PAID</strong></td>
                                        </tr>
                                        <tr>
                                         ...
                                         <table class="ticket-layout" cellpadding="0" cellspacing="0" border="0">
                                             <tr>
                                                 <td class="ticket-info">
                                                     ...
                                                     <p style="margin: 0 0 8px 0;"><strong>Location:</strong><br>The Met Fifth Avenue</p>
                        ...
                        <tr>
                            <td class="footer">
                                <div class="logo">THE MET</div>
                                <p style="margin: 0 0 10px 0;">1000 Fifth Avenue, New York, NY 10028</p>
                                <p style="margin: 0 0 10px 0;">Need help? Contact us at <a href="mailto:support@metmuseum.org">support@metmuseum.org</a></p>
                                <p style="margin: 0; color: #666666;">&copy; {{ date('Y') }} The Metropolitan Museum of Art. All rights reserved.</p>
                            </td>
                        </tr>
