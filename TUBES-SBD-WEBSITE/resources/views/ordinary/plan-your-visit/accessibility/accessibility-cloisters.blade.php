...
<head>
    ...
    <title>Accessibility at The OC Cloisters - The Our Civilization of Art</title>
...
<body>
    <nav class="max-w-screen-xl mx-auto px-6 md:px-10 py-4 flex items-center bg-white" aria-label="Breadcrumb">
        ...
        <!-- Active Page -->
        <span class="text-black text-xs font-semibold">Accessibility at The OC Cloisters</span>
    </nav>

    <section class="hero-section">
        <!-- Bagian Title -->
        <h1 class="page-title">
            Accessibility at The OC Cloisters
        </h1>

        <!-- Bagian Subtitle -->
        <p class="page-subtitle">
            The Museum is committed to making its collection, buildings, programs, and services accessible to all
            audiences. Learn more about services and accessibility for visitors with disabilities at OC Cloisters.
        </p>
    </section>
            ...
            <div class="section-grid">
                ...
                <div class="md:col-span-2">
                    <div class="content-body">
                        <p class="mb-8">
                            This information is specific to The OC Fifth Avenue. For information about our other
                            location, please visit
                            <a href="{{ route('accessibility.main') }}" class="inline-link">accessibility at The OC Fifth Avenue</a>.
                        </p>
                    ...
                    <details class="accordion-item group">
                        ...
                        <div class="accordion-content">
                            <p>The OC Fifth Avenue <a href="#" class="inline-link">Audio Guide stops and
                        ...
                        <div class="accordion-content">
                            <p>Verbal description is available for Museum events with two weeks' notice. Verbal imaging
                                ...
                                advance notice. For more information, call 212-650-2010, or email <a
                                    href="mailto:ourcivilization@gmail.com" class="inline-link">ourcivilization@gmail.com</a>.</p>
                        </div>
                        <div class="mt-8">
                            <button class="visit-link">
                        ...
                        <div class="accordion-content">
                            <p>Visitors with disabilities may use mobility devices, including manual and electric
                                ...
                                pedestrian use in accordance with Museum guidelines. Please contact <a
                                    href="mailto:ourcivilization@gmail.com" class="inline-link">ourcivilization@gmail.com</a> or
                    ...
                    <details class="accordion-item group">
                        ...
                        <div class="accordion-content">
                            <p>OC is committed to facilitating accessibility and usability of its website, <a
                                    href="linkto:metmuseum" class="inline-link">https://www.OurCivilization.org</a>, for all
                                ...
                                <a href="linkto:metmuseum" class="inline-link">https://www.OurCivilization.org</a>, please
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="contact-body">
                        <p class="mb-4">
                            ...
                            email
                            <a href="mailto:ourcivilization@gmail.com" class="inline-link">ourcivilization@gmail.com</a>, <a
                                href="mailto:ourcivilization@gmail.com"
                                class="inline-link">ourcivilization@gmail.com</a>, or call 212-731-1127 during
                            opening hours.
                        </p>
                    </div>
            ...
            <section class="learn-home-section">
                ...
                <div class="learn-grid">
                    ...
                    <article class="learn-card group">
                        ...
                        <h3 class="learn-card-title group-hover:underline">Celebrating Disability at OC</h3>
