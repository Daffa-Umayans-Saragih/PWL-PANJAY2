                ...
                <div class="md:col-span-2">
                    <div class="content-body">
                        <p class="mb-8">
                            ...
                            <a href="{{ route('accessibility.cloisters') }}" class="inline-link">accessibility at OC Cloisters</a>.
                        </p>
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="contact-body">
                        <p class="mb-4">
                            ...
                            email
                            <a href="mailto:ourcivilization@gmail.com" class="inline-link">ourcivilization@gmail.com</a>.
                        </p>
                    </div>
