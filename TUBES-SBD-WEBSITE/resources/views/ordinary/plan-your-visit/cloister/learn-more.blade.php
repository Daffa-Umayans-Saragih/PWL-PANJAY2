...
<head>
    ...
    <title>OC Cloisters - Our Civilization of Art</title>
    ...
    <div class="max-w-screen-xl mx-auto px-6 md:px-10">
        ...
        <section id="locations" class="py-8">
            ...
            <div class="button-ticket-container-group">
                <button onclick="window.location='{{ route('ticket.admission') }}'" class="bg-blue-950 hover:bg-blue-900 text-white font-semibold py-2 px-4 rounded mb-3btn-ticket-responsive">
                    Buy tickets
                </button>
            </div>
        </section>
        ...
        <div class="cloisters-card">
            ...
            <div class="lg:order-first">
                <h3 class="cloisters-title">OC Fifth Avenue</h3>
                <p class="cloisters-desc">
                    See information about visiting OC Fifth Avenue, including directions, admission prices, and
                    dining options.
                </p>
