            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-bottom: 1.5rem;">
                <div class="form-group">
                    ...
                    <input type="text" id="first_name" name="first_name" 
                           ...
                           style="width: 100%; padding: 0.75rem 1rem; border: 1px solid #ccc; border-radius: 8px; font-size: 0.95rem; box-sizing: border-box; transition: border-color 0.2s;" 
                           required>
                    @error('first_name')
            ...
            @if ($source === 'Users')
                <div style="margin-bottom: 2.5rem; padding: 1.25rem; background: #f9f9f9; border-radius: 8px; border: 1px solid #eaeaea;">
                    ...
                    <label style="display: flex; align-items: center; gap: 0.75rem; cursor: pointer; user-select: none;">
                        ...
                        <input type="checkbox" name="is_admin" value="1" {{ old('is_admin', $is_admin) ? 'checked' : '' }} style="width: 18px; height: 18px; cursor: pointer;">
